...
- Produce the smallest set of atomic, fully self-contained factual claims (hard cap: 3).
- Prefer content-bearing, verifiable propositions; discard stylistic, sensational, or affective language.
- Do not split trivially; if two variants are near-duplicates, keep only the most informative factual one.
"""
